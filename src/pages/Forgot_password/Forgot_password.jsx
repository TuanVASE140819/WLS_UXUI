      ...
      <div className="login">
        <div className="login__wrapper">
          <div className="forgot">
            <button className="forgot__popup__close_suggest">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div className="forgot__title">Quên mật khẩu</div>
            <div className="forgot__content">Xác nhận Email</div>
          ...
          <div className="forgot">
            ...
            <div className="forgot__title">Quên mật khẩu</div>
            <div className="forgot__content">Nhập mã PIN</div>
            <div className="forgot__form">
              <input
                type="email"
                name="email"
          ...
          <div className="forgot">
            ...
            <div className="forgot__title">Quên mật khẩu</div>
            <div className="forgot__content">Nhập mật khẩu</div>
            <div className="forgot__form--password">
              <input
              ...
              />
              <button type="submit" className="forgot__btn--summit">
                Xác nhận
              </button>
            </div>
          </div>
