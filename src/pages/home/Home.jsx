...
const Home = () => {
  ...
  return (
    <>
      <Hero />
      <Slider />
      <div className="contentTopSchool">
        <div className="contentTopSchool__wrapper">
          ...
          <div className="contentTopSchool__right">
            <div className="topSchool__container">
      ...
      <div className="contentMedia">
        <div className="contentMedia__wrapper">
          <figure className="contentMedia__image">
            <img
              src={require("../../assets/images/contentMedia-1.png")}
              alt=""
            />
          </figure>
          <div className="contentMedia__content">
            <div className="contentMedia__header">
              <h4>HỘ NGỘ BẠN BÈ, ÔN LẠI KỈ NIỆM</h4>
              <h5>Cùng WELOVESCHOOL</h5>
            </div>
            <h6 className="contentMedia__title">
              Tìm trường cũ của bạn thật đơn giản
            </h6>
            <p className="contentMedia__desc">
              WeLoveSchool giúp bạn Khám phá mái trường xưa nơi bạn từng gắn bó
            </p>
            <h6 className="contentMedia__title">Đăng tin hội ngộ bạn cũ</h6>
            <p className="contentMedia__desc">
              Gửi lời nhắn đến bạn cũ, WeLoveSchool giúp bạn tìm thấy họ Vun đắp
              tình bạn, cùng nhau viết tiếp những câu chuyện dang dở
            </p>
            <h6 className="contentMedia__title">
              Chia sẽ kỉ niệm tại page trường - blog cá nhân
            </h6>
            <p className="contentMedia__desc">
              Lưu giữ khoảnh khắc đẹp, chia sẻ kỷ niệm tuổi học trò Khoe ảnh,
              viết bài, cùng WeLoveSchool lưu giữ ký ức tuổi thơ Kết nối cộng
              đồng, chia sẻ niềm vui và nỗi buồn tuổi học trò chia sẽ khoảnh
              khắc cuộc sống, công việc hiện tại
            </p>
            <h6 className="contentMedia__title">
              Thoải mái trò chuyện “chating, chat group”
            </h6>
            <p className="contentMedia__desc">
              Tám chuyện, chém gió cùng bạn bè, thầy cô - Vui như ngày xưa! Tạo
              nhóm chat, kết nối bạn bè cùng lớp, cùng trường Hội ngộ online,
              cùng nhau ôn lại kỷ niệm và chia sẻ cuộc sống hiện tại Kết nối bạn
              bè mọi lúc mọi nơi, dù ở bất kỳ đâu trên thế giới
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="locationLinks">
        <div className="locationLinks__wrapper">
          <div className="locationLinks__links">
            <Link to="/search" className="locationLinks__link">
              Hồ Chí Minh (100)
            </Link>
            <Link to="/search" className="locationLinks__link">
              Hà Nội (50)
