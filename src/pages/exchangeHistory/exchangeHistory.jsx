...
import GiftHistory from "../../components/Gift/HistoryGift";
...
const ExchangeHistory = () => {
  ...
  return (
    <div className="gift">
      <div className="exchange__wrapper">
        ...
        <div className="gift__filters">
          <Link
            ...
            to="/information?filter=exchange-history"
          ...
          <Link
            ...
            to="/information?filter=coins-history"
          ...
          <Link
            className={`gift__button__history  ${
              selectedFilter === "gifts-history" ? "active" : ""
            }`}
            to="/information?filter=gifts-history"
            onClick={() => setSelectedFilter("gifts-history")}
          >
            Lịch sử nhận quà
          </Link>
        </div>
      ...
      {selectedFilter === "gifts-history" && <GiftHistory />}
    </div>
  );
};
