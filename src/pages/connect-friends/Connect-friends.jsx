        ...
        <div className="connects">
          ...
          <div className="connects__wrapper">
              ...
              <div className="userInfo__wrapper">
                <form className="userInfo__form">
                  ...
                  <div className="userInfo__input">
                    ...
                    <textarea
                      placeholder="Hãy mô tả thêm bạn của bạn"
                      cols="30"
                      rows="8"
                    ></textarea>
                  </div>
            ...
            <div className="searchBar2__inputSearch">
              ...
              <select>
                <option style={{ display: "none" }}>Chọn khóa</option>
...
export default ConnectsFriends;
