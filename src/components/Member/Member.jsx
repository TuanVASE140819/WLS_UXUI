        ...
        <div className="members__items">
          <div className="members__item">
            <div className="members__info">
              <figure className="members__image">
                <img
              ...
              <div className="members__name">Hồ Lê Bảo Hân</div>
            </div>
            <div className="members__school">Trường Đại Học FPT</div>
            <div className="members__point">Điểm: 100</div>
            <button className="members__btn">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
