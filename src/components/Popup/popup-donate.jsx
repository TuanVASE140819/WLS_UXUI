...
import "./popup.scss";
const PopupDonate = ({ info, isOpen, onClose }) => {
        ...
        <div className="popup__wrapper">
          <div className="popup__content">
            <div className="popup__header">
              ...
              <h2 className="popup__title__donate">{info.title}</h2>
            </div>
            <div className="popup__body">
              <div class="popup__choose--option">
                <div class="popup__choose--option__title">
                  <input
                    type="radio"
                    id="donateOption1"
                    ...
                    value="option1"
                  />
                  <label for="donateOption1">10 </label>
                </div>
                <div class="popup__choose--option__title">
                  <input
                    type="radio"
                    ...
                    value="option2"
                  />
                  <label for="donateOption2">20</label>
                </div>
                <div class="popup__choose--option__title">
                  <input
                    type="radio"
                    ...
                    value="option3"
                  />
                  <label for="donateOption3">30</label>
                </div>
              </div>
              <form className="popup__form">
                <div className="popup__donate">
                  <div className="popup__donate__title">
                    <h4>{info.subTitle}</h4>
                  </div>
                  <div className="popup__donate--wrapper">
                    <button onClick={decrease} className="popup__btn">
                      -
                    </button>
                    <input
                      type="number"
                      placeholder="Số sao"
                      className="popup__input--donate"
                      min="0"
                      max="5"
                      value={value}
                      readOnly
                    ...
                    <button onClick={increase} className="popup__btn">
                      +
                    </button>
                  </div>
                </div>
